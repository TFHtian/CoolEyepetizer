...
import com.cooleyepetizer.app.activity.home.*
...
class HomeEventHandler {
    ...
    fun jumpToCategoryDetail(item: CategoryBean){
        val intent = Intent(BaseApplication.instance,CategoryDetailActivity::class.java)
        intent.putExtra(Constant.CATEGORY_INFO,item)
        BaseApplication.instance.startActivity(intent)
    }
