...
class HomeRepository {
    ...
    fun getTopicDetail(id: Long,resultCallBack: ResultCallBack<TopicDetailBean>?){
        val api = RetrofitEyeFactory.createService(HomeService::class.java)
        RetrofitEyeFactory.executeResult(api.getTopicDetailData(id),object:
            ResultTipObserver<TopicDetailBean>(BaseApplication.instance){
