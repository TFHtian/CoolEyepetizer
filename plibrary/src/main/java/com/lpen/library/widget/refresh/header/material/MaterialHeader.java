package com.lpen.library.widget.refresh.header.material;
...
import com.lpen.library.widget.refresh.api.RefreshKernel;
...
import com.lpen.library.widget.refresh.internal.InternalAbstract;
import com.lpen.library.widget.refresh.util.DensityUtil;
import com.lpen.library.widget.refresh.util.SmartUtil;
...
public class MaterialHeader extends InternalAbstract implements RefreshHeader {
    ...
    public MaterialHeader(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        thisView.setMinimumHeight(DensityUtil.dp2px(120));

        mProgress = new MaterialProgressDrawable(this);
        mProgress.setBackgroundColor(CIRCLE_BG_LIGHT);
        mProgress.setAlpha(255);
        mProgress.setColorSchemeColors(0xFF05B570);
        ...
        mBezierPaint.setColor(ta.getColor(R.styleable.MaterialHeader_mhPrimaryColor, 0xFF05B570));
    ...
    public void onMoving(boolean isDragging, float percent, int offset, int height, int maxDragHeight) {
        ...
        if (isDragging || (!mProgress.isRunning() && !mFinished)) {
            ...
            if (mState != RefreshState.Refreshing) {
                ...
                circleView.setAlpha(Math.min(1f, originalDragPercent * 4));
            }

            float targetY = offset / 2 + mCircleDiameter;
