package com.lpen.library.widget.refresh;
...
import com.lpen.library.widget.refresh.api.*;
import com.lpen.library.widget.refresh.constant.DimensionStatus;
import com.lpen.library.widget.refresh.constant.RefreshState;
import com.lpen.library.widget.refresh.constant.SpinnerStyle;
import com.lpen.library.widget.refresh.footer.ClassicsFooter;
import com.lpen.library.widget.refresh.header.material.MaterialHeader;
import com.lpen.library.widget.refresh.impl.RefreshContentWrapper;
import com.lpen.library.widget.refresh.impl.RefreshFooterWrapper;
import com.lpen.library.widget.refresh.impl.RefreshHeaderWrapper;
import com.lpen.library.widget.refresh.impl.ScrollBoundaryDeciderAdapter;
import com.lpen.library.widget.refresh.listener.*;
import com.lpen.library.widget.refresh.util.DelayedRunnable;
import com.lpen.library.widget.refresh.util.DensityUtil;
import com.lpen.library.widget.refresh.util.ViscousFluidInterpolator;
...
import static com.lpen.library.widget.refresh.util.DensityUtil.dp2px;
import static com.lpen.library.widget.refresh.util.SmartUtil.*;
...
//    protected boolean mEnableNestedScrollingOnly = false;//是否只启用嵌套滚动模式，关闭传功滚动模式（启用之后，嵌套滚动也自动被开启，默认如果开启嵌套滚动的话，传功滚动模式必要时也辅助滚动）
    ...
    protected boolean mDisableContentWhenLoading = false;//是否开启在加载时候禁止操作内容视图
...
//    protected boolean mManualNestedScrolling = false;//是否手动设置过 NestedScrolling，用于智能开启
    ...
    protected float mHeaderMaxDragRate = 2.0f;  //最大拖动比率(最大高度/Header高度)
    protected float mFooterMaxDragRate = 1.5f;  //最大拖动比率(最大高度/Footer高度)
        ...
        if (!thisView.isInEditMode()) {
            ...
            if (mRefreshHeader == null) {
                if (sHeaderCreator != null) {
                    ...
                    setRefreshHeader(new MaterialHeader(thisView.getContext()));
                }
            }
